...
@override
String toString() {
  return 'StreamDto(url: $url, id: $id, bitrate: $bitrate, contentType: $contentType, codec: $codec, protocol: $protocol, isHttps: $isHttps, works: $works)';
}
...
class _StreamDto implements StreamDto {
  const _StreamDto({required this.url, this.id, this.bitrate, this.contentType, this.codec, this.protocol, this.isHttps, this.works});
