...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Genre&&(identical(other.id, id) || other.id == id)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.radioCount, radioCount) || other.radioCount == radioCount));
}
...
@override
String toString() {
  return 'Genre(id: $id, slug: $slug, name: $name, radioCount: $radioCount)';
}
...
class _Genre implements Genre {
  const _Genre({required this.id, this.slug, this.name, this.radioCount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Genre&&(identical(other.id, id) || other.id == id)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.radioCount, radioCount) || other.radioCount == radioCount));
}
