...
mixin _$FavoritesState {
 ...
 List<FavoriteStation> get items; bool get isLoading; AppFailure? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoritesState&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error));
}
...
@override
String toString() {
  return 'FavoritesState(items: $items, isLoading: $isLoading, error: $error)';
}
...
@useResult
$Res call({
 List<FavoriteStation> items, bool isLoading, AppFailure? error
});
...
as List<FavoriteStation>,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<FavoriteStation> items,  bool isLoading,  AppFailure? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<FavoriteStation> items,  bool isLoading,  AppFailure? error)  $default,) {final _that = this;
switch (_that) {
case _FavoritesState():
return $default(_that.items,_that.isLoading,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<FavoriteStation> items,  bool isLoading,  AppFailure? error)?  $default,) {final _that = this;
switch (_that) {
case _FavoritesState() when $default != null:
return $default(_that.items,_that.isLoading,_that.error);case _:
  return null;
...
class _FavoritesState implements FavoritesState {
  const _FavoritesState({final  List<FavoriteStation> items = const <FavoriteStation>[], this.isLoading = true, this.error}): _items = items;
  

 final  List<FavoriteStation> _items;
@override@JsonKey() List<FavoriteStation> get items {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FavoritesState&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error));
}
